...
class GameScene_Level_3 extends Scene {
    ROTATION_RIGHT = 0;
    ROTATION_LEFT = 180;
    ROTATION_UP = -90;
    ROTATION_DOWN = 90;
...
//-------CREATE FUNCTIONS
    ...
    createKey() {
        this.blueStar = this.physics.add.sprite(420, 350, 'star');
        // this.blueStar.setTint(0x006db2);
        this.blueStar.setScale(2.0);
    ...
    checkForWin() {
        if (this.player.x >= 404 && this.player.x <= 420 && this.player.y === 72 && this.itemCollected) {
            this.physics.pause();
...
export default GameScene_Level_3
